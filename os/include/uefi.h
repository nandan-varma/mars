...
struct EFI_BLOCK_IO_PROTOCOL {
    ...
    EFI_STATUS(EFIAPI *ReadBlocks)(EFI_BLOCK_IO_PROTOCOL *This, UINT32 MediaId, UINT64 Lba, UINTN BufferSize, VOID *Buffer);
    EFI_STATUS(EFIAPI *WriteBlocks)(EFI_BLOCK_IO_PROTOCOL *This, UINT32 MediaId, UINT64 Lba, UINTN BufferSize, VOID *Buffer);
    EFI_STATUS(EFIAPI *FlushBlocks)(EFI_BLOCK_IO_PROTOCOL *This);
};

#define EFI_BLOCK_IO_PROTOCOL_GUID \
    (EFI_GUID) { 0x1E5668E2, 0x8481, 0x11D4, { 0xBC, 0xF1, 0x00, 0x80, 0xC7, 0x3C, 0x88, 0x81 } }

typedef struct EFI_SIMPLE_NETWORK_PROTOCOL EFI_SIMPLE_NETWORK_PROTOCOL;
struct EFI_SIMPLE_NETWORK_PROTOCOL {
    UINT64 Revision;
    VOID *WaitForPacket;
    EFI_STATUS(EFIAPI *Open)(EFI_SIMPLE_NETWORK_PROTOCOL *This, VOID *Reserved);
    EFI_STATUS(EFIAPI *Close)(EFI_SIMPLE_NETWORK_PROTOCOL *This);
    EFI_STATUS(EFIAPI *Start)(EFI_SIMPLE_NETWORK_PROTOCOL *This);
    EFI_STATUS(EFIAPI *Stop)(EFI_SIMPLE_NETWORK_PROTOCOL *This);
    EFI_STATUS(EFIAPI *Initialize)(EFI_SIMPLE_NETWORK_PROTOCOL *This, UINTN TxRxBufferSize, UINTN RxBufferSize, UINTN TxBufferSize);
    EFI_STATUS(EFIAPI *Reset)(EFI_SIMPLE_NETWORK_PROTOCOL *This);
    EFI_STATUS(EFIAPI *Shutdown)(EFI_SIMPLE_NETWORK_PROTOCOL *This);
    EFI_STATUS(EFIAPI *ReceiveFilter)(EFI_SIMPLE_NETWORK_PROTOCOL *This, UINT32 Enable, UINT32 Disable, UINTN Mask);
    EFI_STATUS(EFIAPI *StationAddress)(EFI_SIMPLE_NETWORK_PROTOCOL *This, BOOLEAN Reset, UINT8 *Address);
    EFI_STATUS(EFIAPI *Statistics)(EFI_SIMPLE_NETWORK_PROTOCOL *This, BOOLEAN Reset, UINTN *Size, VOID *Statistics);
    EFI_STATUS(EFIAPI *ReadCSR)(EFI_SIMPLE_NETWORK_PROTOCOL *This, UINT32 Offset, UINT32 *Buffer);
    EFI_STATUS(EFIAPI *WriteCSR)(EFI_SIMPLE_NETWORK_PROTOCOL *This, UINT32 Offset, UINT32 Buffer);
    EFI_STATUS(EFIAPI *GetStatus)(EFI_SIMPLE_NETWORK_PROTOCOL *This, UINT32 *InterruptStatus, VOID **TxBuffer);
    EFI_STATUS(EFIAPI *Transmit)(EFI_SIMPLE_NETWORK_PROTOCOL *This, UINTN HeaderSize, UINTN BufferSize, VOID *Buffer, VOID *Token);
    EFI_STATUS(EFIAPI *Receive)(EFI_SIMPLE_NETWORK_PROTOCOL *This, UINTN *HeaderSize, UINTN *BufferSize, VOID *Buffer, VOID *Token);
    EFI_STATUS(EFIAPI *WaitForReceive)(EFI_SIMPLE_NETWORK_PROTOCOL *This, UINTN *Status);
    UINT8 Mode[48];
};

#define EFI_SIMPLE_NETWORK_PROTOCOL_GUID \
    (EFI_GUID) { 0xA19832B9, 0xAC9E, 0x4F3A, { 0xB8, 0xC2, 0x53, 0x06, 0x3D, 0xC3, 0xF1, 0xA5 } }

typedef struct EFI_PXE_BASE_CODE_PROTOCOL EFI_PXE_BASE_CODE_PROTOCOL;
typedef struct EFI_PXE_BASE_CODE_CALLBACK_PROTOCOL EFI_PXE_BASE_CODE_CALLBACK_PROTOCOL;
...
typedef struct {
    ...
    UINT32 DhcpDiscoverTryCount;
    UINT32 DhcpRtryCount;
    UINT32 ArcProto;
    BOOLEAN UseBis;
    UINT32 LogLevel;
    UINT32 MaxRetry;
...
struct EFI_PXE_BASE_CODE_PROTOCOL {
    UINT64 Revision;
    EFI_STATUS(EFIAPI *Start)(EFI_PXE_BASE_CODE_PROTOCOL *This, BOOLEAN UseBis);
    EFI_STATUS(EFIAPI *Stop)(EFI_PXE_BASE_CODE_PROTOCOL *This);
    EFI_STATUS(EFIAPI *Dhcp)(EFI_PXE_BASE_CODE_PROTOCOL *This, BOOLEAN SortOffers);
    EFI_STATUS(EFIAPI *Discover)(EFI_PXE_BASE_CODE_PROTOCOL *This, UINT16 Layer, UINT16 *Arc);
    EFI_STATUS(EFIAPI *Mtftp)(EFI_PXE_BASE_CODE_PROTOCOL *This, EFI_PXE_BASE_CODE_CALLBACK_PROTOCOL *Callback, UINT8 OpCode, UINT32 Filelen, UINTN *Buffer, UINTN *Length, VOID *Data);
    EFI_STATUS(EFIAPI *SetIpFilter)(EFI_PXE_BASE_CODE_PROTOCOL *This, UINT8 *Filter);
    EFI_STATUS(EFIAPI *Arp)(EFI_PXE_BASE_CODE_PROTOCOL *This, EFI_IP_ADDRESS *IpAddr, EFI_IP_ADDRESS *MacAddr);
    EFI_STATUS(EFIAPI *SetParameters)(EFI_PXE_BASE_CODE_PROTOCOL *This, UINT8 *UseBis, UINT32 *AutoArp, UINT32 *SendGUID, UINT32 *DhcpDiscoverTryCount, UINT32 *DhcpRtryCount, UINT32 *RetryMs);
    EFI_STATUS(EFIAPI *SetStationIP)(EFI_PXE_BASE_CODE_PROTOCOL *This, EFI_IP_ADDRESS *IP);
    EFI_STATUS(EFIAPI *SetPackets)(EFI_PXE_BASE_CODE_PROTOCOL *This, BOOLEAN *Discover, BOOLEAN *Tftp, BOOLEAN *Mtftp);
    UINT8 Reserved[44];
...
#define EFI_PC_SPEAKER_GUID \
    (EFI_GUID) { 0xA1E3772B, 0xBC4B, 0x4F61, { 0xAA, 0x87, 0xA7, 0x50, 0xE5, 0x6B, 0x43, 0x4D } }

#define PC_SPEAKER_PORT 0x61
#define PC_SPEAKER_TIMER_FREQ 1193182
